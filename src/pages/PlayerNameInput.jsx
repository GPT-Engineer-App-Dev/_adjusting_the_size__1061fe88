...
const PlayerNameInput = ({ playerNames, setPlayerNames, startGame }) => {
  ...
  return (
    <VStack spacing={2}>
      ...
      <Button leftIcon={<FaUserPlus />} colorScheme="teal" onClick={addPlayer} isDisabled={playerNames.length >= 5} size="md">
        Add Player
      </Button>
      <Button colorScheme="green" onClick={startGame} isDisabled={playerNames.some((name) => name.trim() === "")} size="md">
        Start Game
      </Button>
    </VStack>
  );
